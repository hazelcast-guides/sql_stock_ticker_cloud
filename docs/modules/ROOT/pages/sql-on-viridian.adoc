...
* https://github.com/hazelcast/hazelcast-cloud-cli[Connect the Command Line Client to your cluster,window=_blank] or open Management Center for your Viridian Cloud instance.
