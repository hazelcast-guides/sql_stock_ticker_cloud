...
= SQL Basics on Viridian (Stock Ticker)
...
This tutorial introduces you to using SQL on Viridian via the SQL browser. You will run streaming queries, perform data enrichment, windowed aggregations, and create a streaming job.
...
* https://docs.hazelcast.com/cloud/get-started[Create a Development cluster in Viridian.,window=_blank]
* https://github.com/hazelcast/hazelcast-cloud-cli[Connect the Command Line Client to your cluster,window=_blank] or open Management Center for your Viridian instance.
